...
extern "C" {
    namespace coreimage {
        float4 mainImage(float iTime,
            ...
            float3 e2 = ether(iTime + 0.8, p, c1.rgg, c2);
            float3 e3 = ether(iTime + 9.6, p, c1.rbb, c2);
            float3 e4 = ether(iTime + 1.6, p, c1.rrg, c2.grg);
            float3 e5 = ether(iTime + 8.8, p, c1.rrb, c2.grg);
            float3 e6 = ether(iTime + 2.4, p, c1.rrb, c2.brr);
            float3 e7 = ether(iTime + 8.0, p, c1.grb, c2.grb);
            float3 e8 = ether(iTime + 3.2, p, c1, c2.rbr);
            float3 e9 = ether(iTime + 7.2, p, c1.grg, c2.grr);
            float3 e10 = ether(iTime + 4.0, p, c1.brg, c2.brr);
            float3 e11 = ether(iTime + 6.4, p, c1.brb, c2.brb);
            float3 e12 = ether(iTime + 4.8, p, c1.brb, c2.grb);
