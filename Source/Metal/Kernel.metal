...
extern "C" {
    namespace coreimage {
        float4 mainImage(float iTime,
            ...
            r2 = powr(r2, 2.)/mag;
            r3 = powr(r3, 2.)/mag;
            float3 e1 = ether(iTime, p, r1*transpose(float4x3(ce1[0], ce2[0], ce3[0], ce4[0])),
                              r1*transpose(float4x3(ce1[1], ce2[1], ce3[1], ce4[1])));
            float3 e2 = ether(iTime + 4.8, p, r2*transpose(float4x3(ce5[0], ce6[0], ce7[0], ce8[0])),
                              r2*transpose(float4x3(ce5[1], ce6[1], ce7[1], ce8[1])));
            float3 e3 = ether(iTime + 3.2, p, r3*transpose(float4x3(ce9[0], ce10[0], ce11[0], ce12[0])),
                              r3*transpose(float4x3(ce9[1], ce10[1], ce11[1], ce12[1])));
